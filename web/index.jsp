...
<%
    ...
    if (userID == null) {
      ...
      script.println("alert('로그인를 해주세요.');");
...
%>
    ...
    <section class="container">
      ...
      <div class="card bg-light mt-3">
        <div class="card-header bg-light">
          <div class="row">
            <div class="col-8 text-left">컴퓨터개론&nbsp;<small>swank</small></div>
        ...
        <div class="card-body">
          ...
          <p class="card-text">강의가 널널함. 학점이 잘 나오고 좋았음</p>
          <div class="row">
      ...
      <div class="card bg-light mt-3">
        <div class="card-header bg-light">
          <div class="row">
            <div class="col-8 text-left">데이터베이스&nbsp;<small>mike</small></div>
            <div class="col-4 text-right">
        ...
        <div class="card-body">
          <h5 class="card-title">
            1학기 2학기로 나눠진 강의입니다.&nbsp;<small>(2018년 2학기)</small>
          </h5>
          <p class="card-text">빡셉니다. 내용이 많고 실습 위주입니다.</p>
          <div class="row">
            <div class="col-9 text-left">
      ...
      <div class="card bg-light mt-3">
        <div class="card-header bg-light">
          <div class="row">
            <div class="col-8 text-left">JAVA&nbsp;<small>tom</small></div>
            <div class="col-4 text-right">
              종합<span style="color: red;">A</span>
            </div>
          </div>
        ...
        <div class="card-body">
          <h5 class="card-title">
            기본 강의에요&nbsp;<small>(2019년 1학기)</small>
          </h5>
          <p class="card-text">쉽고 재미있게 들었습니다.</p>
          <div class="row">
            <div class="col-9 text-left">
              성적<span style="color: red;">A</span>
              널널<span style="color: red;">A</span>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <div class="modal-title" id="modal">평가등록</div>
          ...
          <div class="modal-body">
            <form action="./evaluationRegisterAction.jsp" method="post">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-sm-3">
                  <label>널널</label>
                  <select name="comforableScore" class="form-control">
                    <option value="A" selected>A</option>
                    <option value="B">B</option>
                    <option value="C">C</option>
                    <option value="D">D</option>
    ...
    <div class="modal fade" id="reportModal" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <div class="modal-title" id="modal">신고하기</div>
            <button class="close" type="button" data-dismiss="modal" aria-label="close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
