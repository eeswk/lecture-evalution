...
<%
    ...
    String host = "http://localhost:8080/lecture_evalution_war_exploded/";
    String from = "구글이메일 계정";
    String to = userDAO.getUserEmail(userID);
    String subject = "강의평가를 위한 인증 메일입니다.";
    String content ="다음 링크접속하여 이메일 인증을 진행하세요." +
...
<section class="container mt-3" style="max-width: 560px;">
    <div class="alert alert-success mt-4" role="alert">
        이메일주소 인증 메일이 전송되었습니다. 회원가입시 입력했던 이메일에 들어가서 인증해주세요.
    </div>
</section>
